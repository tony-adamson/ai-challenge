//! w3d3 — веб-чат с явной моделью памяти агента, профилем пользователя и
//! состоянием задачи как конечным автоматом.
...
use store::{Chat, Entry, Kind, LongTerm, Profile, Stage, Store, Working, DATA_DIR};
...
async fn start() -> Result<(), String> {
    println!("AI Advent · w3d3 — состояние задачи");
