//! w2d3 — веб-чат со счётчиком токенов. Здесь только HTTP: маршруты, общее
//! состояние и переклад событий агента в SSE. История лежит в файлах
//! (`store.rs`), формат API провайдеров и вся арифметика токенов — в
//! `agent.rs`.
...
async fn start() -> Result<(), String> {
    println!("AI Advent · w2d3 — агент, который считает токены");
